...
public class GradebookControllerTest {
    ...
    @Test
    public void createANonValidGradeHttpRequestInvalidGradeTypeEmptyResponse() throws Exception {
        MvcResult mvcResult = mockMvc.perform(post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade", "85.00")
    ...
    @Test
    public void deleteANonValidGradeHttpRequestInvalidGradeTypeEmptyResponse() throws Exception {
        Optional<MathGrade> mathGrade = mathGradeDAO.findById(1);
        assertTrue(mathGrade.isPresent());
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/grades/{id}/{gradeType}", 1, "chemistry"))
                .andExpect(status().isOk()).andReturn();
