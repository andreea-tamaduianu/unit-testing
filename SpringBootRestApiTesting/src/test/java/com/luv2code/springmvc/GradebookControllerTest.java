...
public class GradebookControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper; //is a class that provides functionality for reading and writing JSON, either to and from basic POJOs or to and from a JSON Tree Model.
    ...
    public void getStudentHttpRequest() throws Exception{
        ...
        collegeStudent.setEmailAddress("chad.darby@gmail.com");
    ...
    @Test
    public void deleteANonValidGradeHttpRequestGradeTypeDoesNotExistEmptyResponse() throws Exception{
